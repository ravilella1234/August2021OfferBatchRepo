...
public class MouseOperations 
{
	...
	public void autoSuggestion() throws InterruptedException
	{
		...
		Thread.sleep(3000);
		List<WebElement> list = driver.findElements(By.xpath("//ul[@class='G43f7e']/li/div/div[2]/div[1]/span[1]"));
		for(int i=0;i<list.size();i++)
		{
			...
			list = driver.findElements(By.xpath("//ul[@class='G43f7e']/li/div/div[2]/div[1]/span[1]"));
		}
	}
